...
// Returns the private 'App\Repository\SystemeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SystemeRepository.php';

return $this->privates['App\\Repository\\SystemeRepository'] = new \App\Repository\SystemeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
